...
mkdir quast_output_bactofidia_contigs/ambiguity_all
...
quast -o quast_output_bactofidia_contigs/ambiguity_all/${name} -r genomes/${assembly_accession}*genomic.fna -m 1000 -t 8 -i 500 --fast --ambiguity-usage all $file
done
