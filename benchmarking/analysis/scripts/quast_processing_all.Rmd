...
#MOB_UNI (default = Unicycler)
quast_output_mob_uni<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_uni/mob_uni_alignments_statistics.csv', sep=',', header=FALSE)
names(quast_output_mob_uni)<-c('strain','bin_name_temp','reference_id','alignment_length','bin_length')
quast_output_mob_uni %<>% mutate(software = "MOB-suite (unicycler)")
#For MOB-suite we will fuse the name of the bin with the name of the strain, to be able to do statistics properly
quast_output_mob_uni<-unite(quast_output_mob_uni,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
quast_output_mob_uni<-quast_output_mob_uni[,c(2,1,4:7)]

#MOB_BAC
quast_output_mob_bac<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_bac/mob_bac_alignments_statistics.csv', sep=',', header=FALSE)
names(quast_output_mob_bac)<-c('strain','bin_name_temp','reference_id','alignment_length','bin_length')
quast_output_mob_bac %<>% mutate(software = "MOB-suite (bactofidia)")
#For MOB-suite we will fuse the name of the bin with the name of the strain, to be able to do statistics properly
quast_output_mob_bac<-unite(quast_output_mob_bac,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
quast_output_mob_bac<-quast_output_mob_bac[,c(2,1,4:7)]

#MOB_TRIMMED
quast_output_mob_trimmed<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_unitrim/mob_unitrim_alignments_statistics.csv', sep=',', header=FALSE)
names(quast_output_mob_trimmed)<-c('strain','bin_name_temp','reference_id','alignment_length','bin_length')
quast_output_mob_trimmed %<>% mutate(software = "MOB-suite (unicycler, trimmed)")
#For MOB-suite we will fuse the name of the bin with the name of the strain, to be able to do statistics properly
quast_output_mob_trimmed<-unite(quast_output_mob_trimmed,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
quast_output_mob_trimmed<-quast_output_mob_trimmed[,c(2,1,4:7)]

#MOB_BAC_FILTERED
quast_output_mob_ec<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_bac_trimmed/mob_bac_trimmed_alignments_statistics.csv', sep=',', header=FALSE)
names(quast_output_mob_ec)<-c('assembly_accession','strain','bin_name_temp','reference_id','alignment_length','bin_length')
quast_output_mob_ec %<>% mutate(software = "MOB-suite (bactofidia, plasmid contigs)")
#For MOB-suite we will fuse the name of the bin with the name of the strain, to be able to do statistics properly
quast_output_mob_ec<-unite(quast_output_mob_ec,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
quast_output_mob_ec<-quast_output_mob_ec[,c(2,1,3,5:8)]

#MOB_BAC_CLEANED
quast_output_mob_clean<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_uni/mob_uni_alignments_statistics.csv', sep=',', header=FALSE)
names(quast_output_mob_clean)<-c('assembly_accession','strain','bin_name_temp','reference_id','alignment_length','bin_length')
quast_output_mob_clean %<>% mutate(software = "MOB-suite (bactofidia, cleaned)")
#For MOB-suite we will fuse the name of the bin with the name of the strain, to be able to do statistics properly
quast_output_mob_clean<-unite(quast_output_mob_clean,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
...
```{r}
quast_output_all<-rbind(quast_output_mob_uni,quast_output_mob_bac,quast_output_mob_trimmed,quast_output_spades)
...
```{r}
#mob
ambiguous_alignments_mob_uni<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_uni/mob_uni_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_uni)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_uni<-unite(ambiguous_alignments_mob_uni,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
ambiguous_alignments_mob_uni<-ambiguous_alignments_mob_uni[,c(1,2,4:8)]
ambiguous_alignments_mob_uni$software<-'MOB-suite (unicycler)'

#mob_bac
ambiguous_alignments_mob_bac<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_bac/mob_bac_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_bac)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_bac<-unite(ambiguous_alignments_mob_bac,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
...
#mob_trimmed
ambiguous_alignments_mob_trimmed<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_unitrim/mob_unitrim_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_trimmed)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_trimmed<-unite(ambiguous_alignments_mob_trimmed,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
...
#mob_ec
ambiguous_alignments_mob_ec<-read.csv('../../mobsuite_EC/results/quast_output2/mob_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_ec)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_ec<-unite(ambiguous_alignments_mob_ec,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
...
#mob_ec3
ambiguous_alignments_mob_ec3<-read.csv('../../mobsuite_EC/results/quast_output3/mob_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_ec3)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_ec3<-unite(ambiguous_alignments_mob_ec3,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
ambiguous_alignments_mob_ec3<-ambiguous_alignments_mob_ec3[,c(1,2,4:8)]
ambiguous_alignments_mob_ec3$software<-'MOB-suite (unicycler, plasmid contigs)'

#mob_clean
ambiguous_alignments_mob_clean<-read.csv('../../mobsuite_clean/results/quast_output_clean2/mob_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_clean)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_clean<-unite(ambiguous_alignments_mob_clean,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
...
#mob_clean3
ambiguous_alignments_mob_clean3<-read.csv('../../mobsuite_clean/results/quast_output_clean3/mob_ambiguous_references.csv', sep=',', header=FALSE)
names(ambiguous_alignments_mob_clean3)<-c('strain','bin_name_temp','reference_id','contig_name','contig_length','start','end')
ambiguous_alignments_mob_clean3<-unite(ambiguous_alignments_mob_clean3,'bin_name',c('strain','bin_name_temp'),remove=FALSE) 
#remove old bin name
ambiguous_alignments_mob_clean3<-ambiguous_alignments_mob_clean3[,c(1,2,4:8)]
ambiguous_alignments_mob_clean3$software<-'MOB-suite (unicycler, cleaned)'
...
ambiguous_alignments_total<-rbind(ambiguous_alignments_mob_uni,ambiguous_alignments_mob_bac,ambiguous_alignments_mob_trimmed,ambiguous_alignments_spades)
...
count_ambiguous_alignments_to_same_replicon<- ambiguous_alignments_total %>% group_by(strain,bin_name,reference_id,contig_name,software) %>% summarise(total_ambiguous_alignments=n())
...
multiple_ambiguous_alignments<-multiple_ambiguous_alignments %>% group_by(strain,bin_name,reference_id,contig_name,software) %>% mutate(max_length=max(contig_length)) %>% ungroup() %>% filter(contig_length==max_length)
...
multiple_ambiguous_alignments_final_substracion_data<-multiple_ambiguous_alignments %>% group_by(strain,bin_name,reference_id,software) %>% summarise(total_substraction_length=sum(ambiguous_substraction_length))
...
quast_output_plasmids_chromosomes<-left_join(quast_output_plasmids_chromosomes,multiple_ambiguous_alignments_final_substracion_data,by=c('strain','bin_name','reference_id','software'))
