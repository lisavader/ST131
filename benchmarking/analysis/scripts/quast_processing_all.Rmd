...
#MOB_BAC_FILTERED
quast_output_mob_ec<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_bac_filtered/mob_bac_filtered_alignments_statistics.csv', sep=',', header=FALSE)
...
#MOB_BAC_CLEANED
quast_output_mob_clean<-read.csv('../../plasmid_reconstruction/results/Ecoli/quast_statistics/mob_bac_cleaned/mob_bac_cleaned_alignments_statistics.csv', sep=',', header=FALSE)
