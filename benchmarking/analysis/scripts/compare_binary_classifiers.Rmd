...
ggplot(contig_type_overview,aes(x=log(contig_length,10),fill=factor(contig_type,level = level_order_contigs)))+
  ...
  labs(title = NULL,x="Log10(Contig length)",y = "Nr. of contigs",fill="Alignment type")+
  theme(axis.text.y=element_text(size=9),axis.text.x=element_text(size=9),axis.title.y=element_text(size=13),axis.title.x=element_text(size=13),legend.text = element_text(size=11),legend.title = element_text(size=13))
```
```{r}
ggsave('../results/figures/contiglengths.png',width = 10,height = 5)
```  
...
upset(df_false,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE, queries = list(list(query = elements, params = list("type","FN","FP"), color = "dark #59DCBC", active = T,query.name = "False Negative"),list(query = elements, params = list("type","FP"), color = "red", active = T,query.name = "False Positive")),query.legend = "top")
#dev.off()
```

```{r}
png(file = "../results/figures/upset2_FP.png",width=7*2,height=2.75*2,units = "in",res = 150)
upset(df_FP,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE,mainbar.y.label ="Nr. of contigs", sets.x.label = "Total contigs per tool", text.scale = c(1.8,1.6,1.8,1.6,1.9,2), point.size = 4, line.size = 1, 
#colour tools:
queries = list(
  #4-way
  list(query = intersects, params = list("mlplasmids","Platon","PlaScope","RFPlasmid"), color = "#2A47A9", active = T),
  #3-way
  list(query = intersects, params = list("mlplasmids","Platon","PlaScope"), color = "#59DCBC", active = T),list(query = intersects, params = list("mlplasmids","PlaScope","RFPlasmid"), color = "#59DCBC", active = T),list(query = intersects, params = list("RFPlasmid","Platon","PlaScope"), color = "#59DCBC", active = T),list(query = intersects, params = list("mlplasmids","RFPlasmid","Platon"), color = "#59DCBC", active = T),
  #2-way
  list(query = intersects, params = list("mlplasmids","Platon"), color = "#F5CA26", active = T),list(query = intersects, params = list("mlplasmids","PlaScope"), color = "#F5CA26", active = T),list(query = intersects, params = list("RFPlasmid","Platon"), color = "#F5CA26", active = T),list(query = intersects, params = list("mlplasmids","RFPlasmid"), color = "#F5CA26", active = T),list(query = intersects, params = list("PlaScope","Platon"), color = "#F5CA26", active = T),list(query = intersects, params = list("PlaScope","RFPlasmid"), color = "#F5CA26", active = T),
  #singular
  list(query = intersects, params = list("mlplasmids"), color = "#EC6545", active = T),list(query = intersects, params = list("Platon"), color = "#EC6545", active = T),list(query = intersects, params = list("PlaScope"), color = "#EC6545", active = T),list(query = intersects, params = list("RFPlasmid"), color = "#EC6545", active = T)))
dev.off()
```
```{r}
png(file = "../results/figures/upset2_FN.png",width=7*2,height=2.75*2,units = "in",res = 150)
upset(df_FN,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE,mainbar.y.label ="Nr. of contigs", sets.x.label = "Total contigs per tool", text.scale = c(1.8,1.6,1.8,1.6,1.9,2), point.size = 4, line.size = 1, 
#colour tools:
queries = list(
  #4-way
  list(query = intersects, params = list("mlplasmids","Platon","PlaScope","RFPlasmid"), color = "#2A47A9", active = T),
...
```{r}
png(file = "../results/figures/upset2_TP.png",width=7*2,height=2.75*2,units = "in",res = 150)
upset(df_TP,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE,mainbar.y.label ="Nr. of contigs", sets.x.label = "Total contigs per tool", text.scale = c(1.8,1.6,1.8,1.6,1.9,2), point.size = 4, line.size = 1, 
#colour tools:
queries = list(
  #4-way
  list(query = intersects, params = list("mlplasmids","Platon","PlaScope","RFPlasmid"), color = "#2A47A9", active = T),
...
```{r}
png(file = "../results/figures/upset2_TN.png",width=7*2,height=2.75*2,units = "in",res = 150)
upset(df_TN,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE,mainbar.y.label ="Nr. of contigs", sets.x.label = "Total contigs per tool", text.scale = c(1.8,1.6,1.8,1.6,1.9,2), point.size = 4, line.size = 1, 
#colour tools:
queries = list(
  #4-way
  list(query = intersects, params = list("mlplasmids","Platon","PlaScope","RFPlasmid"), color = "#2A47A9", active = T),
...
upset(df_TN_excluded,sets = rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")), order.by = "freq",keep.order = TRUE, queries = list(list(query = intersects, params = list("mlplasmids","Platon","PlaScope"), color = "#59DCBC", active = T),list(query = intersects, params = list("mlplasmids","PlaScope","RFPlasmid"), color = "#59DCBC", active = T),list(query = intersects, params = list("RFPlasmid","Platon","PlaScope"), color = "#59DCBC", active = T),list(query = intersects, params = list("mlplasmids","RFPlasmid","Platon"), color = "#59DCBC", active = T),list(query = intersects, params = list("mlplasmids"), color = "#EC6545", active = T),list(query = intersects, params = list("Platon"), color = "#EC6545", active = T),list(query = intersects, params = list("PlaScope"), color = "#EC6545", active = T),list(query = intersects, params = list("RFPlasmid"), color = "#EC6545", active = T)))
dev.off()
```
Use log scale
...
plot_ind <- ggplot(metrics_plotting_data %>% filter(group=="individual"),aes(y=factor(software,level = rev(software_levels)),x=value))+
  geom_point(size=3,aes(colour=factor(metric,level = metrics_levels)))+
  labs(y=NULL,x=NULL,colour="Metric:")+
  scale_colour_manual(labels=c("Recall(contig)","Precision(contig)","F1-Score(contig)"),values=c("#4c7af2","#f2924c","#f24c76"))+
  scale_y_discrete(labels=rev(c("mlplasmids","PlaScope","Platon","RFPlasmid")))+
  xlim(0.69,1)+
  theme(axis.text.y=element_text(size=12),axis.text.x=element_text(size=10),legend.text = element_text(size=13),legend.title = element_text(size=13))
```

```{r}
plot_ens <- ggplot(metrics_plotting_data %>% filter(group=="ensemble"),aes(y=factor(software,level = rev(software_levels)),x=value))+
  geom_point(size=3,aes(colour=factor(metric,level = metrics_levels)))+
  labs(y=NULL,x="Score",colour="Metric:")+
  scale_colour_manual(labels=c("Recall(contig)","Precision(contig)","F1-Score(contig)"),values=c("#4c7af2","#f2924c","#f24c76"))+
...
```{r}
ggsave("../results/figures/all_metrics.png",width = 12, height = 5)
```
...
```{r}
time+mem+plot_layout(ncol = 1)
```

```{r}
ggsave("../results/figures/cpu.png",width = 10, height = 5)
```
