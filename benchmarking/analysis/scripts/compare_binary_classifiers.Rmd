...
```{r}
pdf(file = "../results/figures/upset2_FP.pdf",width = 10,height = 7)
...
```
```{r}
pdf(file = "../results/figures/upset2_FN.pdf",width = 10,height = 7)
...
```{r}
pdf(file = "../results/figures/upset2_TP.pdf",width = 10,height = 7)
...
```{r}
pdf(file = "../results/figures/upset2_TN.pdf",width = 10,height = 7)
