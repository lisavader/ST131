...
packages <- c("proxy","magrittr","dplyr","stats","ggplot2","stringr","Rtsne","ape","circlize","RColorBrewer","gplots","ComplexHeatmap","phylogram")
...
anno =HeatmapAnnotation(ST = metadata_anno$ST, col=list(ST=colour_vector))
Heatmap(jaccard_matrix, heatmap_width = unit(20, "cm"), heatmap_height = unit(20, "cm"),show_row_names = FALSE, show_column_names = FALSE,col = col_fun, cluster_rows = as.dendrogram(hclust_out), cluster_columns = as.dendrogram(hclust_out), top_annotation = anno)
```
